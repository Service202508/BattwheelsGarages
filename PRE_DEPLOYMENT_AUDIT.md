...
- **Remediation:** In `server.py`, replace `_cors_origins_raw = "*"` with your specific domains: `allow_origins=["https://rebuild-session.preview.emergentagent.com", "https://app.battwheels.com"]`. Set `CORS_ORIGINS` env var in production.
