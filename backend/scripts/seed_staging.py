"""
Seed script for battwheels_staging — production essentials only.
Connects DIRECTLY to battwheels_staging. Does NOT use the running app.
NO demo orgs. NO test data. NO Volt Motors.
"""
