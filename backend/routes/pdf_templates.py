...
@router.post("/")
async def create_template(data: PDFTemplateCreate):
...
async def update_template(template_id: str, data: PDFTemplateUpdate):
    """Update a template"""
...
async def get_default_template(template_type: str):
...
@router.post("/preview")
async def preview_template(template_id: str, sample_data: Dict = None):
