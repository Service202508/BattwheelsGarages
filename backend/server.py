...
V1_ROUTES = [
    ...
    "routes.razorpay", "routes.razorpay_routes", "routes.einvoice",
    ...
    "routes.sales_finance_api", "routes.hr_payroll_api", "routes.operations_api",
]
...
_cors_origins = [o.strip() for o in os.environ.get("CORS_ORIGINS", "https://battwheels.com,https://app.battwheels.com,https://failure-card-modal.preview.emergentagent.com").split(",") if o.strip()]
if os.environ.get("NODE_ENV") != "production":
    _cors_origins += ["http://localhost:3000", "http://localhost:3001"]
app.add_middleware(CORSMiddleware, allow_credentials=True, allow_origins=_cors_origins, allow_methods=["GET","POST","PUT","PATCH","DELETE","OPTIONS","HEAD"], allow_headers=["Authorization","Content-Type","X-Organization-ID","X-Requested-With","Accept"])
