...
_cors_origins = [o.strip() for o in os.environ.get("CORS_ORIGINS", "https://battwheels.com,https://app.battwheels.com,https://accounting-sprint2d.preview.emergentagent.com").split(",") if o.strip()]
