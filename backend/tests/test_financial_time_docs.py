...
class TestFinancialDashboardAPIs:
    ...
    def test_financial_summary(self, auth_headers):
        """GET /api/v1/dashboard/financial/summary - returns receivables and payables"""
        response = requests.get(f"{BASE_URL}/api/v1/dashboard/financial/summary", headers=auth_headers)
    ...
    def test_cash_flow(self, auth_headers):
        """GET /api/v1/dashboard/financial/cash-flow - returns monthly cash flow"""
        response = requests.get(f"{BASE_URL}/api/v1/dashboard/financial/cash-flow", headers=auth_headers)
        assert response.status_code == 200, f"Expected 200, got {response.status_code}: {response.text}"
    ...
    def test_cash_flow_with_period(self, auth_headers):
        """GET /api/v1/dashboard/financial/cash-flow with different periods"""
        periods = ["fiscal_year", "last_12_months", "last_6_months"]
        for period in periods:
            response = requests.get(
                f"{BASE_URL}/api/v1/dashboard/financial/cash-flow?period={period}", 
    ...
    def test_income_expense(self, auth_headers):
        """GET /api/v1/dashboard/financial/income-expense - returns income/expense breakdown"""
        response = requests.get(f"{BASE_URL}/api/v1/dashboard/financial/income-expense", headers=auth_headers)
        assert response.status_code == 200, f"Expected 200, got {response.status_code}: {response.text}"
    ...
    def test_income_expense_methods(self, auth_headers):
        """GET /api/v1/dashboard/financial/income-expense with accrual and cash methods"""
        methods = ["accrual", "cash"]
        for method in methods:
            response = requests.get(
                f"{BASE_URL}/api/v1/dashboard/financial/income-expense?method={method}",
                headers=auth_headers
            )
            assert response.status_code == 200
            data = response.json()
    ...
    def test_top_expenses(self, auth_headers):
        """GET /api/v1/dashboard/financial/top-expenses - returns expense categories"""
        response = requests.get(f"{BASE_URL}/api/v1/dashboard/financial/top-expenses", headers=auth_headers)
        assert response.status_code == 200, f"Expected 200, got {response.status_code}: {response.text}"
    ...
    def test_bank_accounts(self, auth_headers):
        """GET /api/v1/dashboard/financial/bank-accounts - returns bank account info"""
        response = requests.get(f"{BASE_URL}/api/v1/dashboard/financial/bank-accounts", headers=auth_headers)
        assert response.status_code == 200, f"Expected 200, got {response.status_code}: {response.text}"
    ...
    def test_projects_watchlist(self, auth_headers):
        """GET /api/v1/dashboard/financial/projects-watchlist - returns active projects"""
        response = requests.get(f"{BASE_URL}/api/v1/dashboard/financial/projects-watchlist", headers=auth_headers)
        assert response.status_code == 200, f"Expected 200, got {response.status_code}: {response.text}"
    ...
    def test_quick_stats(self, auth_headers):
        """GET /api/v1/dashboard/financial/quick-stats - returns dashboard stats"""
        response = requests.get(f"{BASE_URL}/api/v1/dashboard/financial/quick-stats", headers=auth_headers)
        assert response.status_code == 200, f"Expected 200, got {response.status_code}: {response.text}"
...
class TestTimeTrackingAPIs:
    ...
    def test_list_time_entries(self, auth_headers):
        """GET /api/v1/time-tracking/entries - returns time entries list"""
        response = requests.get(f"{BASE_URL}/api/v1/time-tracking/entries", headers=auth_headers)
        assert response.status_code == 200, f"Expected 200, got {response.status_code}: {response.text}"
    ...
    def test_create_time_entry(self, auth_headers):
        """POST /api/v1/time-tracking/entries - creates new time entry"""
        entry_data = {
            "user_id": "test_user",
    ...
    def test_get_time_entry(self, auth_headers):
        """GET /api/v1/time-tracking/entries/{entry_id} - get specific entry"""
        ...
        response = requests.get(f"{BASE_URL}/api/v1/time-tracking/entries/{entry_id}", headers=auth_headers)
        assert response.status_code == 200
    ...
    def test_update_time_entry(self, auth_headers):
        """PUT /api/v1/time-tracking/entries/{entry_id} - update time entry"""
        if not hasattr(TestTimeTrackingAPIs, 'created_entry_id'):
            pytest.skip("No entry created to test")
        ...
        response = requests.put(
            f"{BASE_URL}/api/v1/time-tracking/entries/{entry_id}",
            json=update_data,
            headers=auth_headers
        )
        assert response.status_code == 200
    ...
    def test_start_timer(self, auth_headers):
        """POST /api/v1/time-tracking/timer/start - starts a timer"""
        timer_data = {
            "user_id": "test_user",
            "user_name": "Test Technician",
        ...
        response = requests.post(
            f"{BASE_URL}/api/v1/time-tracking/timer/start",
            json=timer_data,
            headers=auth_headers
        )
        assert response.status_code == 200, f"Expected 200, got {response.status_code}: {response.text}"
    ...
    def test_get_active_timers(self, auth_headers):
        """GET /api/v1/time-tracking/timer/active - get active timers"""
        response = requests.get(f"{BASE_URL}/api/v1/time-tracking/timer/active", headers=auth_headers)
        assert response.status_code == 200
    ...
    def test_stop_timer(self, auth_headers):
        """POST /api/v1/time-tracking/timer/stop/{timer_id} - stops timer"""
        ...
        response = requests.post(
            f"{BASE_URL}/api/v1/time-tracking/timer/stop/{timer_id}?hourly_rate=500",
            headers=auth_headers
        )
        assert response.status_code == 200, f"Expected 200, got {response.status_code}: {response.text}"
    ...
    def test_get_unbilled_hours(self, auth_headers):
        """GET /api/v1/time-tracking/unbilled - get unbilled summary"""
        response = requests.get(f"{BASE_URL}/api/v1/time-tracking/unbilled", headers=auth_headers)
        assert response.status_code == 200
    ...
    def test_time_summary_report(self, auth_headers):
        """GET /api/v1/time-tracking/reports/summary - get time summary report"""
        response = requests.get(f"{BASE_URL}/api/v1/time-tracking/reports/summary", headers=auth_headers)
        assert response.status_code == 200
    ...
    def test_delete_time_entry(self, auth_headers):
        """DELETE /api/v1/time-tracking/entries/{entry_id} - cleanup test entry"""
        if not hasattr(TestTimeTrackingAPIs, 'created_entry_id'):
            pytest.skip("No entry created to test")
        
        entry_id = TestTimeTrackingAPIs.created_entry_id
        response = requests.delete(f"{BASE_URL}/api/v1/time-tracking/entries/{entry_id}", headers=auth_headers)
        assert response.status_code == 200
...
class TestDocumentsAPIs:
    ...
    def test_list_documents(self, auth_headers):
        """GET /api/v1/documents/ - returns documents list"""
    ...
    def test_list_folders(self, auth_headers):
        """GET /api/v1/documents/folders - returns folders list"""
        response = requests.get(f"{BASE_URL}/api/v1/documents/folders", headers=auth_headers)
        assert response.status_code == 200, f"Expected 200, got {response.status_code}: {response.text}"
    ...
    def test_create_folder(self, auth_headers):
        """POST /api/v1/documents/folders - creates new folder"""
        folder_data = {
        ...
        response = requests.post(
            f"{BASE_URL}/api/v1/documents/folders",
            json=folder_data,
            headers=auth_headers
        )
        assert response.status_code == 200, f"Expected 200, got {response.status_code}: {response.text}"
    ...
    def test_document_stats_summary(self, auth_headers):
        """GET /api/v1/documents/stats/summary - returns document stats"""
        response = requests.get(f"{BASE_URL}/api/v1/documents/stats/summary", headers=auth_headers)
        assert response.status_code == 200, f"Expected 200, got {response.status_code}: {response.text}"
    ...
    def test_create_document(self, auth_headers):
        """POST /api/v1/documents/ - creates new document"""
        doc_data = {
    ...
    def test_get_document(self, auth_headers):
        ...
        response = requests.get(f"{BASE_URL}/api/v1/documents/{doc_id}", headers=auth_headers)
        assert response.status_code == 200
    ...
    def test_list_tags(self, auth_headers):
        """GET /api/v1/documents/tags/all - returns all tags"""
        response = requests.get(f"{BASE_URL}/api/v1/documents/tags/all", headers=auth_headers)
        assert response.status_code == 200
    ...
    def test_delete_document(self, auth_headers):
        """DELETE /api/v1/documents/{document_id} - cleanup test document"""
        if not hasattr(TestDocumentsAPIs, 'created_doc_id'):
            pytest.skip("No document created to test")
        
        doc_id = TestDocumentsAPIs.created_doc_id
        response = requests.delete(f"{BASE_URL}/api/v1/documents/{doc_id}", headers=auth_headers)
        assert response.status_code == 200
        
        print(f"✓ Document deleted: ID={doc_id}")
    
    def test_delete_folder(self, auth_headers):
        """DELETE /api/v1/documents/folders/{folder_id} - cleanup test folder"""
        ...
        response = requests.delete(f"{BASE_URL}/api/v1/documents/folders/{folder_id}", headers=auth_headers)
        assert response.status_code == 200
