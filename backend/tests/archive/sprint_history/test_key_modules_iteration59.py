...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://security-hardening-17.preview.emergentagent.com').rstrip('/')
...
class TestDashboard:
    ...
    def test_org_info(self, headers):
        ...
        response = requests.get(f"{BASE_URL}/api/v1/org", headers=headers)
        assert response.status_code == 200
...
class TestItems:
    ...
    def test_items_search(self, headers):
        """Test items search"""
        response = requests.get(f"{BASE_URL}/api/v1/items-enhanced/?search=battery", headers=headers)
        assert response.status_code == 200
        data = response.json()
    ...
    def test_create_and_get_item(self, headers):
        ...
        create_res = requests.post(f"{BASE_URL}/api/v1/items-enhanced/", headers=headers, json=item_data)
        ...
        # Get item
        if item_id:
            get_res = requests.get(f"{BASE_URL}/api/v1/items-enhanced/{item_id}", headers=headers)
...
class TestInventoryEnhanced:
    ...
    def test_inventory_summary(self, headers):
        ...
        response = requests.get(f"{BASE_URL}/api/v1/inventory-enhanced/summary", headers=headers)
        assert response.status_code == 200
        data = response.json()
    ...
    def test_variants_list(self, headers):
        ...
        response = requests.get(f"{BASE_URL}/api/v1/inventory-enhanced/variants", headers=headers)
        assert response.status_code == 200
        data = response.json()
    ...
    def test_bundles_list(self, headers):
        ...
        response = requests.get(f"{BASE_URL}/api/v1/inventory-enhanced/bundles", headers=headers)
        assert response.status_code == 200
        data = response.json()
    ...
    def test_serial_batches_list(self, headers):
        ...
        response = requests.get(f"{BASE_URL}/api/v1/inventory-enhanced/serial-batches?status=all", headers=headers)
        assert response.status_code == 200
        data = response.json()
    ...
    def test_shipments_list(self, headers):
        ...
        response = requests.get(f"{BASE_URL}/api/v1/inventory-enhanced/shipments", headers=headers)
        assert response.status_code == 200
        data = response.json()
    ...
    def test_returns_list(self, headers):
        ...
        response = requests.get(f"{BASE_URL}/api/v1/inventory-enhanced/returns", headers=headers)
        assert response.status_code == 200
        data = response.json()
    ...
    def test_low_stock_report(self, headers):
        ...
        response = requests.get(f"{BASE_URL}/api/v1/inventory-enhanced/reports/low-stock", headers=headers)
        assert response.status_code == 200
        data = response.json()
    ...
    def test_create_warehouse(self, headers):
        ...
        response = requests.post(f"{BASE_URL}/api/v1/inventory-enhanced/warehouses", headers=headers, json=warehouse_data)
...
class TestSalesOrders:
    ...
    def test_sales_orders_list(self, headers):
        ...
        response = requests.get(f"{BASE_URL}/api/v1/sales-orders-enhanced/", headers=headers)
        assert response.status_code == 200
        data = response.json()
    ...
    def test_sales_orders_summary(self, headers):
        ...
        response = requests.get(f"{BASE_URL}/api/v1/sales-orders-enhanced/summary", headers=headers)
        assert response.status_code == 200
        data = response.json()
    ...
    def test_fulfillment_summary(self, headers):
        ...
        response = requests.get(f"{BASE_URL}/api/v1/sales-orders-enhanced/reports/fulfillment-summary", headers=headers)
        assert response.status_code == 200
        data = response.json()
...
class TestTimeTracking:
    ...
    def test_time_entries_list(self, headers):
        ...
        response = requests.get(f"{BASE_URL}/api/v1/time-tracking/entries", headers=headers)
        assert response.status_code == 200
        data = response.json()
    ...
    def test_projects_list(self, headers):
        ...
        response = requests.get(f"{BASE_URL}/api/v1/time-tracking/projects", headers=headers)
        assert response.status_code == 200
        data = response.json()
...
class TestDocuments:
    ...
    def test_document_folders(self, headers):
        ...
        response = requests.get(f"{BASE_URL}/api/v1/documents/folders", headers=headers)
...
class TestCustomerPortal:
    """Customer Portal tests at /api/v1/customer-portal endpoints"""
    ...
    def portal_session(self, admin_headers):
        ...
        # First get a contact
        contacts_res = requests.get(f"{BASE_URL}/api/v1/contacts-enhanced/", headers=admin_headers)
        ...
        # Enable portal
        enable_res = requests.post(f"{BASE_URL}/api/v1/contacts-enhanced/{contact_id}/enable-portal", headers=admin_headers)
        ...
        # Login to portal
        login_res = requests.post(f"{BASE_URL}/api/v1/customer-portal/login", json={"token": portal_token})
    ...
    def test_portal_dashboard_with_query(self, portal_session):
        ...
        response = requests.get(
            f"{BASE_URL}/api/v1/customer-portal/dashboard?session_token={portal_session}"
        )
        assert response.status_code == 200
