...
class TestS1_06_CORSNoWildcard:
    ...
    def test_allowed_origin_gets_correct_acao(self):
        ...
        allowed = "https://beta-readiness-2.preview.emergentagent.com"
        resp = requests.options(
            f"{self.INTERNAL_URL}/api/v1/health",
            headers={
                "Origin": allowed,
    ...
    def test_cors_allow_origins_list_is_not_wildcard(self):
        ...
        cors_raw = os.environ.get(
            "CORS_ORIGINS",
            "https://battwheels.com,https://app.battwheels.com,https://beta-readiness-2.preview.emergentagent.com",
        )
