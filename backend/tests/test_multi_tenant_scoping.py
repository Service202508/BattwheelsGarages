...
class TestVehiclesScoping:
    ...
    def setup(self):
        ...
        # Get org_id
        org_response = requests.get(f"{BASE_URL}/api/org", headers=self.headers)
