...
class TestNotificationAPI:
    ...
    def setup(self):
        ...
        # Login to get token
        login_res = self.session.post(f"{BASE_URL}/api/v1/auth/login", json={
    ...
    def test_create_notification(self):
        """Test POST /api/v1/notifications - Create notification"""
        payload = {
            "user_id": "",
            "role": "admin",
        ...
        res = self.session.post(f"{BASE_URL}/api/v1/notifications", json=payload)
    ...
    def test_list_notifications(self):
        """Test GET /api/v1/notifications - List notifications with unread count"""
        res = self.session.get(f"{BASE_URL}/api/v1/notifications?role=admin&per_page=50")
    ...
    def test_get_unread_count(self):
        ...
        res = self.session.get(f"{BASE_URL}/api/v1/notifications/unread-count?role=admin")
    ...
    def test_mark_notification_as_read(self):
        ...
        create_res = self.session.post(f"{BASE_URL}/api/v1/notifications", json=payload)
        assert create_res.status_code == 200
        notification_id = create_res.json()["notification"]["notification_id"]
        
        # Mark as read
        res = self.session.put(f"{BASE_URL}/api/v1/notifications/{notification_id}/read")
        ...
        get_res = self.session.get(f"{BASE_URL}/api/v1/notifications/{notification_id}")
    ...
    def test_mark_all_as_read(self):
        """Test PUT /api/v1/notifications/mark-all-read"""
        # Create a few unread notifications
        for i in range(2):
            self.session.post(f"{BASE_URL}/api/v1/notifications", json={
                "role": "admin",
        ...
        # Mark all as read
        res = self.session.put(f"{BASE_URL}/api/v1/notifications/mark-all-read?role=admin")
        ...
        count_res = self.session.get(f"{BASE_URL}/api/v1/notifications/unread-count?role=admin")
    ...
    def test_get_notification_details(self):
        """Test GET /api/v1/notifications/{id} - Get notification details"""
        ...
        # Get details
        res = self.session.get(f"{BASE_URL}/api/v1/notifications/{notification_id}")
    ...
    def test_archive_notification(self):
        """Test DELETE /api/v1/notifications/{id} - Archive notification"""
        # Create a notification
        create_res = self.session.post(f"{BASE_URL}/api/v1/notifications", json={
            "role": "admin",
        ...
        # Archive it
        res = self.session.delete(f"{BASE_URL}/api/v1/notifications/{notification_id}")
...
class TestExportAPI:
    ...
    def setup(self):
        ...
        customer_res = self.session.post(f"{BASE_URL}/api/v1/zoho/contacts", json={
        ...
        if customer_res.status_code == 200:
            ...
            list_res = self.session.get(f"{BASE_URL}/api/v1/zoho/contacts?contact_type=customer&per_page=1")
        ...
        # Create test invoice
        if self.customer_id:
            invoice_res = self.session.post(f"{BASE_URL}/api/v1/zoho/invoices", json={
            ...
            if invoice_res.status_code == 200:
                ...
                inv_list = self.session.get(f"{BASE_URL}/api/v1/zoho/invoices?per_page=1")
    ...
    def test_generate_einvoice(self):
        """Test GET /api/v1/export/einvoice/{invoice_id} - Generate GST e-invoice JSON"""
        ...
        res = self.session.get(f"{BASE_URL}/api/v1/export/einvoice/{self.invoice_id}")
    ...
    def test_download_einvoice(self):
        """Test GET /api/v1/export/einvoice/{invoice_id}/download - Download e-invoice JSON file"""
        if not self.invoice_id:
            inv_list = self.session.get(f"{BASE_URL}/api/v1/zoho/invoices?per_page=1")
            if inv_list.status_code == 200 and inv_list.json().get("invoices"):
                self.invoice_id = inv_list.json()["invoices"][0]["invoice_id"]
        ...
        res = self.session.get(f"{BASE_URL}/api/v1/export/einvoice/{self.invoice_id}/download")
    ...
    def test_export_invoices_to_tally(self):
        """Test GET /api/v1/export/tally/invoices - Export invoices as Tally XML"""
        res = self.session.get(f"{BASE_URL}/api/v1/export/tally/invoices?limit=10")
    ...
    def test_export_ledgers_to_tally(self):
        """Test GET /api/v1/export/tally/ledgers - Export contacts as Tally ledgers"""
        res = self.session.get(f"{BASE_URL}/api/v1/export/tally/ledgers")
    ...
    def test_bulk_export_invoices_csv(self):
        """Test GET /api/v1/export/bulk/invoices?format=csv - Export invoices as CSV"""
        res = self.session.get(f"{BASE_URL}/api/v1/export/bulk/invoices?format=csv")
    ...
    def test_bulk_export_invoices_json(self):
        """Test GET /api/v1/export/bulk/invoices?format=json - Export invoices as JSON"""
        res = self.session.get(f"{BASE_URL}/api/v1/export/bulk/invoices?format=json")
    ...
    def test_bulk_export_expenses_csv(self):
        """Test GET /api/v1/export/bulk/expenses?format=csv - Export expenses as CSV"""
        res = self.session.get(f"{BASE_URL}/api/v1/export/bulk/expenses?format=csv")
...
class TestNotificationEventTriggers:
    ...
    def test_check_overdue_invoices(self):
        """Test POST /api/v1/notifications/check-overdue-invoices"""
        res = self.session.post(f"{BASE_URL}/api/v1/notifications/check-overdue-invoices")
    ...
    def test_check_expiring_amcs(self):
        """Test POST /api/v1/notifications/check-expiring-amcs"""
        res = self.session.post(f"{BASE_URL}/api/v1/notifications/check-expiring-amcs")
    ...
    def test_check_low_stock(self):
        """Test POST /api/v1/notifications/check-low-stock"""
        res = self.session.post(f"{BASE_URL}/api/v1/notifications/check-low-stock")
    ...
    def test_notification_preferences_get(self):
        """Test GET /api/v1/notifications/preferences/{user_id}"""
        res = self.session.get(f"{BASE_URL}/api/v1/notifications/preferences/test_user_001")
    ...
    def test_notification_preferences_update(self):
        """Test PUT /api/v1/notifications/preferences/{user_id}"""
        payload = {
        ...
        res = self.session.put(f"{BASE_URL}/api/v1/notifications/preferences/test_user_002", json=payload)
...
class TestCleanup:
    ...
    def test_cleanup_test_notifications(self):
        ...
        res = self.session.get(f"{BASE_URL}/api/v1/notifications?per_page=100")
        if res.status_code == 200:
            notifications = res.json().get("notifications", [])
            archived = 0
            for notif in notifications:
                if notif.get("title", "").startswith("TEST_"):
                    del_res = self.session.delete(f"{BASE_URL}/api/v1/notifications/{notif['notification_id']}")
