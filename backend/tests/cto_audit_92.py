...
BASE_URL = os.environ.get('API_BASE_URL', 'https://production-hardened-2.preview.emergentagent.com')
...
def run():
    ...
    r = c.post(f"{API_URL}/auth/login", json={"email": ADMIN_EMAIL, "password": "wrongpassword"})
