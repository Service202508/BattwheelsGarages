...
|----------|----------|--------------|----------------|------------|
| `MONGO_URL` | **Yes** | Your MongoDB provider (Atlas, self-hosted) | `mongodb+srv://user:pass@cluster.mongodb.net/battwheels` | App won't start |
...
| `RAZORPAY_KEY_ID` | Optional | Razorpay Dashboard → API Keys | `rzp_live_abc123` | Payments won't work |
