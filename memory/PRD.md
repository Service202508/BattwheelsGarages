...
- **Feb 2026**: Dependency upgrade sprint — FastAPI 0.110.1→0.132.0, starlette 0.37.2→0.52.1, motor 3.3.1→3.7.1, pymongo 4.5.0→4.16.0. Resolves CVE-2024-47874, CVE-2025-54121 (starlette), CVE-2024-5629 (pymongo). 35/35 regression tests pass. Startup index migration hook added. `regex=` deprecation fixed in tickets.py.
