...
- **Feb 2026**: Dependency upgrade sprint — FastAPI 0.110.1→0.132.0, starlette 0.37.2→0.52.1 (CVE-2024-47874, CVE-2025-54121), motor 3.3.1→3.7.1, pymongo 4.5.0→4.16.0 (CVE-2024-5629). 35/35 regression tests pass. Startup index migration hook added. `regex=` deprecation fixed in tickets.py. GitHub Actions security-audit workflow added at `.github/workflows/security-audit.yml` (pip-audit + npm audit on every PR, fails on any HIGH/CRITICAL unignored CVE).
