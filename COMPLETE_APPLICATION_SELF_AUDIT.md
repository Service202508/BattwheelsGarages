...
CORS_ORIGINS=https://security-scan-54.preview.emergentagent.com
...
## 3. `frontend/.env`
```
REACT_APP_BACKEND_URL=https://security-scan-54.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
- Backend: 8001
- Frontend: 3000
- External access: Via Emergent preview URL (https://security-scan-54.preview.emergentagent.com)
