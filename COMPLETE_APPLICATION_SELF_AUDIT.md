...
CORS_ORIGINS=https://readiness-checkpoint.preview.emergentagent.com
...
## 3. `frontend/.env`
```
REACT_APP_BACKEND_URL=https://readiness-checkpoint.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
- Backend: 8001
- Frontend: 3000
- External access: Via Emergent preview URL (https://readiness-checkpoint.preview.emergentagent.com)
