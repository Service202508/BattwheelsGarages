...
const PremiumHeroSection = () => {
  ...
  return (
    <section className="relative min-h-[90vh] overflow-hidden bg-gradient-to-br from-green-50 via-white to-emerald-50/30 flex items-center">
      {/* Background Mesh - Green/White Palette */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-0 left-0 w-[600px] h-[600px] bg-green-300/40 rounded-full mix-blend-multiply filter blur-3xl animate-blob" />
        <div className="absolute top-20 right-0 w-[500px] h-[500px] bg-emerald-200/50 rounded-full mix-blend-multiply filter blur-3xl animate-blob animation-delay-2000" />
        <div className="absolute bottom-0 left-1/3 w-[550px] h-[550px] bg-green-400/30 rounded-full mix-blend-multiply filter blur-3xl animate-blob animation-delay-4000" />
      </div>
        ...
        <div className="container mx-auto px-4 py-12 lg:py-16">
          ...
          <div className={`grid lg:grid-cols-2 gap-8 lg:gap-16 items-center transform transition-all duration-1000 ${
            ...
            <div className="flex flex-col justify-center space-y-6 order-2 lg:order-1">
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-green-600 to-emerald-500 bg-clip-text text-transparent">
            ...
            <div className="flex flex-col justify-center space-y-6 bg-white/80 backdrop-blur-sm rounded-3xl p-6 lg:p-8 border border-green-100 shadow-xl order-1 lg:order-2">
