...
export default function Attendance({ user }) {
  ...
  const getStatusBadge = (status) => {
    const styles = {
      ...
      half_day: "bg-[rgba(234,179,8,0.08)]0",
      absent: "bg-[rgba(255,59,47,0.08)]0",
      on_leave: "bg-blue-500",
      short_day: "bg-[rgba(255,140,0,0.08)]0",
    };
          ...
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="flex-1 space-y-4">
              ...
              {todayAttendance?.attendance?.late_arrival && (
                <div className="flex items-center gap-2 p-3 bg-[rgba(234,179,8,0.08)]0/10 text-yellow-500 rounded-lg">
                  <AlertTriangle className="h-4 w-4" />
                  <span className="text-sm">Late arrival recorded</span>
                </div>
              )}
              {todayAttendance?.attendance?.early_departure && (
                <div className="flex items-center gap-2 p-3 bg-[rgba(255,140,0,0.08)]0/10 text-orange-500 rounded-lg">
                  <AlertTriangle className="h-4 w-4" />
            ...
            <div className="flex flex-col gap-3">
              ...
              {isClockedOut && (
                <div className="text-center p-4 bg-[rgba(34,197,94,0.08)]0/10 rounded-lg">
                            ...
                            <TableCell>
                              <div className="flex items-center gap-2">
                                <Progress 
                                  ...
                                  className={`w-16 h-2 ${stat.productivity_percentage >= 100 ? 'bg-[rgba(34,197,94,0.08)]0' : ''}`} 
                                />
