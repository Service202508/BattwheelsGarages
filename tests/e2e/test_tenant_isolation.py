...
# ── Config ──────────────────────────────────────────────────────────────────
API_URL = os.getenv("REACT_APP_BACKEND_URL", "https://production-hardened-2.preview.emergentagent.com")
BASE = f"{API_URL}/api"
...
ADMIN_FREE   = {"email": "freetester@test.com",          "password": "testpass123"}
